    ...
    <v-container>
        <v-form v-model="form.valid" ref="form" @submit.prevent="$store.commit('form/send')">
            <v-row dense justify="center" align="center">
                ...
                <v-col cols="12" md="4">
                    <v-text-field v-model="form.data.burnedCalories" :rules="form.rules.number" :label="$t('burnedCalories')" type="number" solo required />
                </v-col>
                <v-col cols="12" md="4">
                    <v-select v-model="form.data.type" :items="typeItems" :label="$t('type')" solo required />
                </v-col>
                <v-col cols="12" md="6">
